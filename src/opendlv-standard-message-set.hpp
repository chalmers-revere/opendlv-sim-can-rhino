...
#ifndef INTERNAL_NOMU_HPP
#define INTERNAL_NOMU_HPP
...
class LIB_API nomU {
    private:
        static constexpr const char* TheShortName = "nomU";
        static constexpr const char* TheLongName = "internal.nomU";
    ...
    public:
        nomU() = default;
        nomU(const nomU&) = default;
        nomU& operator=(const nomU&) = default;
        nomU(nomU&&) = default;
        nomU& operator=(nomU&&) = default;
        ~nomU() = default;

    public:
        
        inline nomU& acc(const double &v) noexcept {
            m_acc = v;
            return *this;
        }
        inline double acc() const noexcept {
            return m_acc;
        }
        
        inline nomU& steer(const double &v) noexcept {
            m_steer = v;
            return *this;
        }
        inline double steer() const noexcept {
            return m_steer;
        }
    ...
    public:
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(1, std::move("double"s), std::move("acc"s), m_acc, preVisit, visit, postVisit);
...
template<>
struct isVisitable<internal::nomU> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<internal::nomU> {
    static const bool value = true;
};
#endif
...
#ifndef INTERNAL_NOMSTATE_HPP
#define INTERNAL_NOMSTATE_HPP
...
namespace internal {
using namespace std::string_literals; // NOLINT
class LIB_API nomState {
    private:
        static constexpr const char* TheShortName = "nomState";
        static constexpr const char* TheLongName = "internal.nomState";
    ...
    public:
        nomState() = default;
        nomState(const nomState&) = default;
        nomState& operator=(const nomState&) = default;
        nomState(nomState&&) = default;
        nomState& operator=(nomState&&) = default;
        ~nomState() = default;

    public:
        
        inline nomState& xp_dot(const double &v) noexcept {
            m_xp_dot = v;
            return *this;
        }
        inline double xp_dot() const noexcept {
            return m_xp_dot;
        }
        
        inline nomState& yp_dot(const double &v) noexcept {
            m_yp_dot = v;
            return *this;
        }
        inline double yp_dot() const noexcept {
            return m_yp_dot;
        }
        
        inline nomState& psi_dot(const double &v) noexcept {
            m_psi_dot = v;
            return *this;
        }
        inline double psi_dot() const noexcept {
            return m_psi_dot;
        }
        
        inline nomState& epsi(const double &v) noexcept {
            m_epsi = v;
            return *this;
        }
        inline double epsi() const noexcept {
            return m_epsi;
        }
        
        inline nomState& ey(const double &v) noexcept {
            m_ey = v;
            return *this;
        }
        ...
        inline nomState& s(const double &v) noexcept {
            m_s = v;
            return *this;
        }
        inline double s() const noexcept {
            return m_s;
        }
        
        inline nomState& steer(const double &v) noexcept {
            m_steer = v;
            return *this;
        }
        inline double steer() const noexcept {
        ...
        inline nomState& acc(const double &v) noexcept {
            m_acc = v;
            return *this;
        }
        inline double acc() const noexcept {
    ...
    public:
        ...
        inline void accept(Visitor &visitor) {
            ...
            doVisit(1, std::move("double"s), std::move("xp_dot"s), m_xp_dot, visitor);
            
            doVisit(2, std::move("double"s), std::move("yp_dot"s), m_yp_dot, visitor);
            
            doVisit(3, std::move("double"s), std::move("psi_dot"s), m_psi_dot, visitor);
            
            doVisit(4, std::move("double"s), std::move("epsi"s), m_epsi, visitor);
            
            doVisit(5, std::move("double"s), std::move("ey"s), m_ey, visitor);
            
            doVisit(6, std::move("double"s), std::move("s"s), m_s, visitor);
            
            doVisit(7, std::move("double"s), std::move("steer"s), m_steer, visitor);
            
            doVisit(8, std::move("double"s), std::move("acc"s), m_acc, visitor);
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(1, std::move("double"s), std::move("xp_dot"s), m_xp_dot, preVisit, visit, postVisit);
            
            doTripletForwardVisit(2, std::move("double"s), std::move("yp_dot"s), m_yp_dot, preVisit, visit, postVisit);
            
            doTripletForwardVisit(3, std::move("double"s), std::move("psi_dot"s), m_psi_dot, preVisit, visit, postVisit);
            
            doTripletForwardVisit(4, std::move("double"s), std::move("epsi"s), m_epsi, preVisit, visit, postVisit);
            
            doTripletForwardVisit(5, std::move("double"s), std::move("ey"s), m_ey, preVisit, visit, postVisit);
            
            doTripletForwardVisit(6, std::move("double"s), std::move("s"s), m_s, preVisit, visit, postVisit);
            
            doTripletForwardVisit(7, std::move("double"s), std::move("steer"s), m_steer, preVisit, visit, postVisit);
            
            doTripletForwardVisit(8, std::move("double"s), std::move("acc"s), m_acc, preVisit, visit, postVisit);
    ...
    private:
        ...
        double m_xp_dot{ 0.0 }; // field identifier = 1.
        
        double m_yp_dot{ 0.0 }; // field identifier = 2.
        
        double m_psi_dot{ 0.0 }; // field identifier = 3.
        
        double m_epsi{ 0.0 }; // field identifier = 4.
        
        double m_ey{ 0.0 }; // field identifier = 5.
        
        double m_s{ 0.0 }; // field identifier = 6.
        
        double m_steer{ 0.0 }; // field identifier = 7.
        
        double m_acc{ 0.0 }; // field identifier = 8.
        
};
}

template<>
struct isVisitable<internal::nomState> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<internal::nomState> {
    static const bool value = true;
};
#endif
